...
/**
 * Servlet implementation class AllPlanList
 */
@WebServlet("/AllPlanList")
public class AllPlanList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (planList != null) {
			...
			System.out.println("##########################");
			rd = request.getRequestDispatcher("/Admin/planlist.jsp");
